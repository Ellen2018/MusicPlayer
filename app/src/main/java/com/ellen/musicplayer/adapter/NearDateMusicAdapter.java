...
public class NearDateMusicAdapter extends BaseSingleRecyclerViewAdapter<NearMusic, NearDateMusicAdapter.NearMusicViewHolder> {

    private View parentView;

    public NearDateMusicAdapter(Context context, View parentView, List<NearMusic> dataList) {
    ...
    protected int getItemLayoutId() {
        return R.layout.item_date_near_music;
    }
    ...
    protected void showData(NearMusicViewHolder nearMusicViewHolder, NearMusic nearMusic, int position) {
        ...
        nearMusicViewHolder.tvPlayTimes.setVisibility(View.GONE);
        nearMusicViewHolder.tvDate.setText("播放日期:"+TimeUtils.formatDate(nearMusic.getPlayTime()));
    ...
    static class NearMusicViewHolder extends BaseViewHolder{
        ...
        TextView tvMusicName, tvSingerName, tvPosition,tvPlayTimes,tvDate;
        ...
        public NearMusicViewHolder(@NonNull View itemView) {
            ...
            tvDate = findViewById(R.id.tv_play_date);
        }
    }
}
